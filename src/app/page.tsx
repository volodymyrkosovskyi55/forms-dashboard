...
export default function Home() {
  return (
    <section className="grid gap-10 rounded-2xl bg-white p-8 shadow-sm md:grid-cols-2 md:items-center">
      ...
      <div className="relative mx-auto h-64 w-full max-w-md overflow-hidden rounded-xl bg-slate-100">
        <Image
          src="/globe.svg"
